...
fun FindMeetingScreen(
    ...
    Column(
        ...
        Text(
            ...
            text = "Time Range",
            style = AppThemeProvider.style.typography.headlineSmall.copy(
                color = AppThemeProvider.colors.primary
            )
        )
        Spacer(modifier = Modifier.size(16.dp))
        Row(
        ...
        Row(
            ...
            Text(
                ...
                text = "Time Zones",
                style = AppThemeProvider.style.typography.headlineSmall.copy(
                    AppThemeProvider.colors.primary
                )
            )
        }
        Spacer(modifier = Modifier.size(16.dp))
...
private fun isSelected(selectedStates: Map<Int, Boolean>, index: Int): Boolean {
    return selectedStates[index] ?: false
}